...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    sym("@markup.heading.1")({ bg = bssm.moon.darken(70).desaturate(60), fg = bssm.moon, gui = "bold" }),
    sym("@markup.heading.2")({ bg = bssm.mercury.darken(70).desaturate(60), fg = bssm.mercury, gui = "bold" }),
    sym("@markup.heading.3")({ bg = bssm.mars.darken(70).desaturate(60), fg = bssm.mars, gui = "bold" }),
    sym("@markup.heading.4")({ bg = bssm.jupiter.darken(70).desaturate(60), fg = bssm.jupiter, gui = "bold" }),
    sym("@markup.heading.5")({ bg = bssm.venus.darken(70).desaturate(60), fg = bssm.venus, gui = "bold" }),
    sym("@markup.heading.6")({ bg = bssm.saturn.darken(70).desaturate(60), fg = bssm.saturn, gui = "bold" }),
