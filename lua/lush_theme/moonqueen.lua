...
local base00  = hsl(257, 36, 6)
local base01  = hsl(257, 36, 12)
local base02  = hsl(257, 36, 18)
local base03  = hsl(252, 15, 48) -- #6f688d
local base04	= hsl(252, 15, 60) -- #908aa8
local base05  = hsl(252, 45, 90)
local base06	= hsl(252, 45, 96)
local base07	= hsl(257, 36, 24)
local base08	= hsl(357, 93, 58)
local base09  = hsl(86, 66, 39)
local base0A	= hsl(55, 97, 54)
local base0B  = hsl(214, 75, 60)
local base0C  = hsl(253, 88, 68)
local base0D	= hsl(319, 97, 77)
local base0E  = hsl(253, 88, 78)
local base0F  = hsl(319, 97, 87)
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    LineNr         { bg = base02, fg = base0E},
    CursorLineNr   { bg = base05, fg = base02, gui = "bold" },
